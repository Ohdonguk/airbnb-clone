...
class GitgubException(Exception):
    pass
...
def kakao_callback(request):
    try:
        ...
        token_request = request.get(
            f"http://kauth.kakao.com/oauth/token?grant_type=authorization_code&client_id={KAKAO_ID}"
        )
